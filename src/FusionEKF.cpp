...
FusionEKF::FusionEKF() {
  ...
  //measurement covariance matrix - laser (because given in manual that standard deviation of position wrt x directn i.e px = 0.15m hence square it we get 0.0225m^2 )
  R_laser_ << 0.0225, 0,
              0, 0.0225;

  //measurement covariance matrix - radar (because given in manual that standard deviation of radial distance and radial velocity i.e ro = 0.3m and rodot = 0.3m hence square it we get 0.009m^2, standard deviation of angle i.e phi = 0.03 hence square it to get 0.0009 )
  R_radar_ << 0.09, 0, 0,
              0, 0.0009, 0,
              0, 0, 0.09;
...
//dt power of 4, 3,2 need for Q matrix
